...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="py-20 bg-[rgb(18,27,27)] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto glass rounded-xl p-8 md:p-10 flex flex-col items-center">
          ...
          <h3 className="text-2xl font-semibold mb-3 text-white">Drop me a line</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button 
              ...
              onClick={() => window.location.href = 'mailto:contact@devmotion.com'}
            >
