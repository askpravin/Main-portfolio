...
const Hero: React.FC = () => {
  ...
  return (
    <section 
      ref={heroRef}
      id="hero" 
      className="min-h-screen relative flex items-center justify-center overflow-hidden bg-grid"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="parallax-bg absolute top-1/4 -left-20 w-72 h-72 rounded-full bg-primary/30 blur-3xl opacity-50"></div>
        <div className="parallax-bg absolute bottom-1/4 -right-20 w-80 h-80 rounded-full bg-accent/20 blur-3xl opacity-50"></div>
        <div className="parallax-bg absolute top-1/3 right-1/4 w-48 h-48 rounded-full bg-secondary/20 blur-3xl opacity-40"></div>
      </div>
      ...
      <div className="container relative z-10 px-4 py-32 mx-auto text-center">
        ...
        <p className="max-w-2xl mx-auto text-foreground/80 text-lg md:text-xl mb-10 opacity-0 animate-fade-in-up delay-4">
        ...
        <div className="opacity-0 animate-fade-in-up delay-5">
          <a 
            href="#projects" 
            className="inline-flex items-center px-6 py-3 bg-primary rounded-lg text-foreground hover:bg-primary/90 transition-colors duration-300"
          >
            View Projects
          </a>
        </div>
