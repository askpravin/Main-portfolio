    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <p className="text-foreground/80 mb-12 max-w-2xl">
          I'm passionate about backend development, working to build reliable
          server solutions and efficient APIs. Currently learning GraphQL to
          expand my toolkit and grow as a developer.
        </p>
